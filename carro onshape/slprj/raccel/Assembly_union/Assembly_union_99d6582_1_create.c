...
) ; extern const NeAssertData Assembly_union_99d6582_1_assertData [ ] ;
extern const NeZCData Assembly_union_99d6582_1_ZCData [ ] ; void
Assembly_union_99d6582_1_computeRuntimeParameters ( const double *
runtimeRootVariables , double * runtimeParameters ) ; void
Assembly_union_99d6582_1_validateRuntimeParameters ( const double *
runtimeParameters , int32_T * assertSatisfactionFlags ) ; void
Assembly_union_99d6582_1_computeAsmRuntimeDerivedValues ( const double *
runtimeParameters , RuntimeDerivedValuesBundle * runtimeDerivedValuesBundle )
; void Assembly_union_99d6582_1_computeSimRuntimeDerivedValues ( const double
* runtimeParameters , RuntimeDerivedValuesBundle * runtimeDerivedValuesBundle
...
const double * , const double * , const double * , const double * , double *
, double * , NeuDiagnosticManager * neDiagMgr ) ; PmfMessageId
Assembly_union_99d6582_1_checkDynamics ( const RuntimeDerivedValuesBundle * ,
const double * , const double * , const double * , const double * , const
double * , double * , NeuDiagnosticManager * neDiagMgr ) ; PmfMessageId
Assembly_union_99d6582_1_compOutputsDyn ( const RuntimeDerivedValuesBundle *
...
Assembly_union_99d6582_1_compOutputsKin ( const RuntimeDerivedValuesBundle *
, const double * , const int * , const double * , const double * , const
double * , const double * , double * , NeuDiagnosticManager * neDiagMgr ) ;
PmfMessageId Assembly_union_99d6582_1_compOutputs ( const
RuntimeDerivedValuesBundle * , const double * , const int * , const double *
, const double * , const double * , const double * , double * ,
NeuDiagnosticManager * neDiagMgr ) ; PmfMessageId
Assembly_union_99d6582_1_computeAsmModeVector ( const double * , const double
* , const double * , int * , double * , NeuDiagnosticManager * neDiagMgr ) ;
PmfMessageId Assembly_union_99d6582_1_computeSimModeVector ( const double * ,
const double * , const double * , int * , double * , NeuDiagnosticManager *
neDiagMgr ) ; PmfMessageId Assembly_union_99d6582_1_computeZeroCrossings (
const RuntimeDerivedValuesBundle * , const double * , const double * , const
double * , const double * , const double * , double * , double * ,
NeuDiagnosticManager * neDiagMgr ) ; void Assembly_union_99d6582_1_setTargets
( const RuntimeDerivedValuesBundle * runtimeDerivedValuesBundle , CTarget *
targets ) ; void Assembly_union_99d6582_1_resetAsmStateVector ( const void *
mech , double * stateVector ) ; void
Assembly_union_99d6582_1_resetSimStateVector ( const void * mech , double *
stateVector ) ; void Assembly_union_99d6582_1_initializeTrackedAngleState (
...
stateVector ) ; void Assembly_union_99d6582_1_adjustPosition ( const void *
...
Assembly_union_99d6582_1_perturbSimJointPrimitiveState ( const void * mech ,
size_t stageIdx , size_t primitiveIdx , double magnitude , boolean_T
doPerturbVelocity , double * stateVector ) ; void
Assembly_union_99d6582_1_perturbFlexibleBodyState ( const void * mech ,
size_t stageIdx , double magnitude , boolean_T doPerturbVelocity , double *
stateVector ) ; void Assembly_union_99d6582_1_computePosDofBlendMatrix (
const void * mech , size_t stageIdx , size_t primitiveIdx , const double *
stateVector , int partialType , double * matrix ) ; void
Assembly_union_99d6582_1_computeVelDofBlendMatrix ( const void * mech ,
...
Assembly_union_99d6582_1_computeAssemblyJacobian ( const void * mech , const
RuntimeDerivedValuesBundle * runtimeDerivedValuesBundle , size_t
...
PmfMessageId Assembly_union_99d6582_1_convertStateVector ( const void *
...
neDiagMgr ) ; void Assembly_union_99d6582_1_constructStateVector ( const void
...
Assembly_union_99d6582_1_extractSolverStateVector ( const void * mech , const
double * fullStateVector , double * solverStateVector ) ; int
Assembly_union_99d6582_1_isPositionViolation ( const void * mech , const
...
modeVector ) ; int Assembly_union_99d6582_1_isVelocityViolation ( const void
* mech , const RuntimeDerivedValuesBundle * runtimeDerivedValuesBundle ,
const int * constraintEqnEnableFlags , const double * stateVector , const int
* modeVector ) ; PmfMessageId Assembly_union_99d6582_1_projectStateSim (
const void * mech , const RuntimeDerivedValuesBundle *
...
neDiagMgr ) ; void Assembly_union_99d6582_1_computeConstraintError ( const
...
Assembly_union_99d6582_1_resetModeVector ( const void * mech , int *
modeVector ) ; boolean_T Assembly_union_99d6582_1_hasJointDisToNormModeChange
( const void * mech , const int * prevModeVector , const int * modeVector ) ;
PmfMessageId Assembly_union_99d6582_1_performJointDisToNormModeChange ( const
void * mech , const RuntimeDerivedValuesBundle * runtimeDerivedValuesBundle ,
const int * prevModeVector , const int * modeVector , const double *
inputVector , double * stateVector , void * neDiagMgr ) ; PmfMessageId
Assembly_union_99d6582_1_onModeChangedCutJoints ( const void * mech , const
int * prevModeVector , int * modeVector , double * stateVector , void *
neDiagMgr ) ; PmfMessageId Assembly_union_99d6582_1_assemble ( const double *
...
return ; Assembly_union_99d6582_1_computeRuntimeParameters (
runtimeRootVariables , smData -> mRuntimeParameterScalars . mX ) ;
Assembly_union_99d6582_1_computeAsmRuntimeDerivedValues ( smData ->
mRuntimeParameterScalars . mX , & dae -> mPrivateData ->
mAsmRuntimeDerivedValuesBundle ) ;
Assembly_union_99d6582_1_computeSimRuntimeDerivedValues ( smData ->
mRuntimeParameterScalars . mX , & dae -> mPrivateData ->
...
; Assembly_union_99d6582_1_validateRuntimeParameters ( runtimeParams ,
...
Assembly_union_99d6582_1_compDerivs ( & smData ->
...
-> mV . mX + 3 , systemInput -> mD . mX , daeMethodOutput -> mXP0 . mX , &
...
Assembly_union_99d6582_1_numJacPerturbLoBounds ( & smData ->
mSimRuntimeDerivedValuesBundle , smData -> mSimulationDelegate .
mRunTimeEnabledEquations . mValues , systemInput -> mX . mX , systemInput ->
mM . mX , systemInput -> mU . mX , systemInput -> mU . mX + 3 , systemInput
...
neDiagMgr ) { const NeDaePrivateData * smData = dae -> mPrivateData ;
PmfMessageId errorId = NULL ; double errorResult = 0.0 ; errorId =
Assembly_union_99d6582_1_numJacPerturbHiBounds ( & smData ->
mSimRuntimeDerivedValuesBundle , smData -> mSimulationDelegate .
mRunTimeEnabledEquations . mValues , systemInput -> mX . mX , systemInput ->
mM . mX , systemInput -> mU . mX , systemInput -> mU . mX + 3 , systemInput
...
errorId = Assembly_union_99d6582_1_computeSimModeVector ( systemInput -> mU .
mX , systemInput -> mU . mX + 3 , systemInput -> mV . mX + 3 ,
...
errorResult = 0.0 ; return Assembly_union_99d6582_1_computeZeroCrossings ( &
smData -> mSimRuntimeDerivedValuesBundle , systemInput -> mX . mX ,
systemInput -> mU . mX , systemInput -> mU . mX + 3 , systemInput -> mV . mX
+ 3 , systemInput -> mD . mX , daeMethodOutput -> mZC . mX , & errorResult ,
...
double result = 0.0 ; errorId = Assembly_union_99d6582_1_checkDynamics ( &
smData -> mSimRuntimeDerivedValuesBundle , systemInput -> mX . mX ,
systemInput -> mU . mX , systemInput -> mU . mX + 3 , systemInput -> mV . mX
+ 3 , systemInput -> mD . mX , & result , neDiagMgr ) ; } return errorId ; }
...
Assembly_union_99d6582_1_computeSimModeVector ( systemInput -> mU . mX ,
...
size_t numTargets = 14 ; unsigned int asmStatus = 0 ; double *
...
Assembly_union_99d6582_1_computeAsmModeVector ( systemInput -> mU . mX ,
...
#if 0
Assembly_union_99d6582_1_checkTargets ( & smData ->
...
mStateVectorSize = 2 ; smData -> mFullStateVectorSize = 8 ; smData ->
...
[ 2 ] = { 2 , 5 } ; const CTarget targets [ 14 ] = { { 0 , 359 , 0 , false ,
0 , 0 , "1" , false , false , + 1.000000000000000000e+00 , true , 1 , { +
0.000000000000000000e+00 , + 0.000000000000000000e+00 , +
0.000000000000000000e+00 , + 0.000000000000000000e+00 } , { +
0.000000000000000000e+00 } } , { 0 , 359 , 0 , false , 0 , 0 , "1" , true ,
false , + 1.000000000000000000e+00 , true , 1 , { + 0.000000000000000000e+00
, + 0.000000000000000000e+00 , + 0.000000000000000000e+00 , +
0.000000000000000000e+00 } , { + 0.000000000000000000e+00 } } , { 0 , 359 , 1
, false , 0 , 0 , "1" , false , false , + 1.000000000000000000e+00 , true , 1
, { + 0.000000000000000000e+00 , + 0.000000000000000000e+00 , +
0.000000000000000000e+00 , + 0.000000000000000000e+00 } , { +
0.000000000000000000e+00 } } , { 0 , 359 , 1 , false , 0 , 0 , "1" , true ,
false , + 1.000000000000000000e+00 , true , 1 , { + 0.000000000000000000e+00
, + 0.000000000000000000e+00 , + 0.000000000000000000e+00 , +
0.000000000000000000e+00 } , { + 0.000000000000000000e+00 } } , { 0 , 359 , 2
, false , 0 , 0 , "1" , false , false , + 1.000000000000000000e+00 , true , 1
, { + 0.000000000000000000e+00 , + 0.000000000000000000e+00 , +
0.000000000000000000e+00 , + 0.000000000000000000e+00 } , { +
0.000000000000000000e+00 } } , { 0 , 359 , 2 , false , 0 , 0 , "1" , true ,
false , + 1.000000000000000000e+00 , true , 1 , { + 0.000000000000000000e+00
, + 0.000000000000000000e+00 , + 0.000000000000000000e+00 , +
0.000000000000000000e+00 } , { + 0.000000000000000000e+00 } } , { 0 , 361 , 0
, false , 0 , 0 , "1" , false , true , + 1.000000000000000000e+00 , true , 1
, { + 0.000000000000000000e+00 , + 0.000000000000000000e+00 , +
0.000000000000000000e+00 , + 0.000000000000000000e+00 } , { +
0.000000000000000000e+00 } } , { 0 , 361 , 0 , false , 0 , 0 , "1" , true ,
true , + 1.000000000000000000e+00 , true , 1 , { + 0.000000000000000000e+00 ,
+ 0.000000000000000000e+00 , + 0.000000000000000000e+00 , +
0.000000000000000000e+00 } , { + 0.000000000000000000e+00 } } , { 0 , 359 , 0
, false , 0 , 3 , "" , false , false , + 1.000000000000000000e+00 , true , 1
, { + 0.000000000000000000e+00 , + 0.000000000000000000e+00 , +
0.000000000000000000e+00 , + 0.000000000000000000e+00 } , { +
0.000000000000000000e+00 } } , { 0 , 359 , 0 , false , 0 , 3 , "" , true ,
false , + 1.000000000000000000e+00 , true , 1 , { + 0.000000000000000000e+00
, + 0.000000000000000000e+00 , + 0.000000000000000000e+00 , +
0.000000000000000000e+00 } , { + 0.000000000000000000e+00 } } , { 0 , 359 , 1
, false , 0 , 3 , "" , false , false , + 1.000000000000000000e+00 , true , 1
, { + 0.000000000000000000e+00 , + 0.000000000000000000e+00 , +
0.000000000000000000e+00 , + 0.000000000000000000e+00 } , { +
0.000000000000000000e+00 } } , { 0 , 359 , 1 , false , 0 , 3 , "" , true ,
false , + 1.000000000000000000e+00 , true , 1 , { + 0.000000000000000000e+00
, + 0.000000000000000000e+00 , + 0.000000000000000000e+00 , +
0.000000000000000000e+00 } , { + 0.000000000000000000e+00 } } , { 0 , 361 , 0
, false , 0 , 3 , "" , false , false , + 1.000000000000000000e+00 , true , 1
, { + 0.000000000000000000e+00 , + 0.000000000000000000e+00 , +
0.000000000000000000e+00 , + 0.000000000000000000e+00 } , { +
0.000000000000000000e+00 } } , { 0 , 361 , 0 , false , 0 , 3 , "" , true ,
false , + 1.000000000000000000e+00 , true , 1 , { + 0.000000000000000000e+00
, + 0.000000000000000000e+00 , + 0.000000000000000000e+00 , +
0.000000000000000000e+00 } , { + 0.000000000000000000e+00 } } } ; const
size_t numTargets = 14 ; int_T status ; size_t i ; status =
...
mNumInputMotionPrimitives = 3 ; PM_ALLOCATE_ARRAY ( smData -> mTargets ,
...
Assembly_union_99d6582_1_assertData ; size_t i ; PM_ALLOCATE_ARRAY ( smData
-> mParamAssertObjects , PmCharVector , 0 , alloc ) ; PM_ALLOCATE_ARRAY (
smData -> mParamAssertPaths , PmCharVector , 0 , alloc ) ; PM_ALLOCATE_ARRAY
...
Assembly_union_99d6582_1_ZCData ; size_t i ; PM_ALLOCATE_ARRAY ( smData ->
...
[ 2 ] = { "Cartesian_Joint.Pz.p" , "Cartesian_Joint.Pz.v" } ; const char *
varObjects [ 2 ] = { "Assembly_union/Cartesian Joint" ,
"Assembly_union/Cartesian Joint" } ; smData -> mNumVarScalars = 2 ; smData ->
mVarFullPaths = NULL ; smData -> mVarObjects = NULL ; if ( smData ->
mNumVarScalars > 0 ) { size_t s ; PmAllocator * alloc = pm_default_allocator
( ) ; PM_ALLOCATE_ARRAY ( smData -> mVarFullPaths , PmCharVector , 2 , alloc
) ; PM_ALLOCATE_ARRAY ( smData -> mVarObjects , PmCharVector , 2 , alloc ) ;
...
= { "Cartesian_Joint.pxi" , "Cartesian_Joint.pyi" , "Revolute_Joint.qi" } ;
const char * inputUnits [ 3 ] = { "m" , "m" , "rad" } ; const SizePair
inputDimensions [ 3 ] = { { 1 , 1 } , { 1 , 1 } , { 1 , 1 } } ; const char *
* outputPortPaths = NULL ; const char * * outputUnits = NULL ; const SizePair
* outputDimensions = NULL ; initIoInfoHelper ( 3 , inputPortPaths ,
...
numInputDerivs [ 3 ] = { 2 , 2 , 2 } ; PmAllocator * alloc =
...
numInputDerivs , 3 * sizeof ( int32_T ) ) ; smData -> mInputOrder = 2 ; }
static void initDirectFeedthrough ( NeDaePrivateData * smData ) { const
boolean_T directFeedthroughVector [ 3 ] = { true , true , true } ; const
boolean_T * directFeedthroughMatrix = NULL ; PmAllocator * alloc =
...
jointToStageIdx [ 2 ] = { { 359 , 0 } , { 361 , 1 } } ; const size_t
primitiveIndices [ 2 + 1 ] = { 0 , 3 , 4 } ; const SmSizePair stateOffsets [
4 ] = { { 0 , 3 } , { 1 , 4 } , { 2 , 5 } , { 6 , 7 } } ; const SmSizePair
dofOffsets [ 4 ] = { { 0 , 1 } , { 1 , 2 } , { 2 , 3 } , { 3 , 4 } } ; const
size_t * flexibleStages = NULL ; const size_t remodIndices [ 1 ] = { 6 } ;
const size_t * equationsPerConstraint = NULL ; const size_t dofToVelSlot [ 4
] = { 3 , 4 , 5 , 7 } ; const size_t * constraintDofs = NULL ; const size_t
...
delegate -> mModeVectorSize = 0 ; delegate -> mNumStages = 2 ; delegate ->
mNumConstraints = 0 ; delegate -> mNumAllConstraintEquations = 0 ;
sm_core_SmSizePairVector_create ( & delegate -> mJointToStageIdx , 2 , &
zeroSizePair ) ; memcpy ( sm_core_SmSizePairVector_nonConstValues ( &
delegate -> mJointToStageIdx ) , jointToStageIdx , 2 * sizeof ( SmSizePair )
...
delegate -> mRemodIndices , 1 , 0 ) ; memcpy (
sm_core_SmSizeTVector_nonConstValues ( & delegate -> mRemodIndices ) ,
remodIndices , 1 * sizeof ( size_t ) ) ; sm_core_SmSizeTVector_create ( &
...
mFullStateVector , 8 , 0.0 ) ; sm_core_SmIntVector_create ( & scratchpad ->
...
0.0 ) ; sm_core_SmRealVector_create ( & scratchpad -> mMotionData , 26 , 0.0
) ; delegate -> mSetTargets = Assembly_union_99d6582_1_setTargets ; delegate
-> mResetStateVector = Assembly_union_99d6582_1_resetAsmStateVector ;
delegate -> mInitializeTrackedAngleState =
Assembly_union_99d6582_1_initializeTrackedAngleState ; delegate ->
mComputeDiscreteState = Assembly_union_99d6582_1_computeDiscreteState ;
delegate -> mAdjustPosition = Assembly_union_99d6582_1_adjustPosition ;
delegate -> mPerturbJointPrimitiveState =
Assembly_union_99d6582_1_perturbAsmJointPrimitiveState ; delegate ->
mPerturbFlexibleBodyState = NULL ; delegate -> mComputePosDofBlendMatrix =
Assembly_union_99d6582_1_computePosDofBlendMatrix ; delegate ->
mComputeVelDofBlendMatrix = Assembly_union_99d6582_1_computeVelDofBlendMatrix
; delegate -> mProjectPartiallyTargetedPos =
Assembly_union_99d6582_1_projectPartiallyTargetedPos ; delegate ->
mPropagateMotion = Assembly_union_99d6582_1_propagateMotion ; delegate ->
mComputeAssemblyError = Assembly_union_99d6582_1_computeAssemblyError ;
delegate -> mComputeAssemblyJacobian =
Assembly_union_99d6582_1_computeAssemblyJacobian ; delegate ->
mComputeFullAssemblyJacobian =
Assembly_union_99d6582_1_computeFullAssemblyJacobian ; delegate ->
mIsInKinematicSingularity = Assembly_union_99d6582_1_isInKinematicSingularity
; delegate -> mConvertStateVector =
Assembly_union_99d6582_1_convertStateVector ; delegate ->
...
= NULL ; const SmSizePair jointToStageIdx [ 2 ] = { { 359 , 0 } , { 361 , 1 }
} ; const size_t primitiveIndices [ 2 + 1 ] = { 0 , 3 , 4 } ; const
SmSizePair stateOffsets [ 4 ] = { { 0 , 3 } , { 1 , 4 } , { 2 , 5 } , { 6 , 7
} } ; const SmSizePair dofOffsets [ 4 ] = { { 0 , 1 } , { 1 , 2 } , { 2 , 3 }
, { 3 , 4 } } ; const size_t * flexibleStages = NULL ; const size_t
remodIndices [ 1 ] = { 6 } ; const size_t * equationsPerConstraint = NULL ;
const size_t dofToVelSlot [ 4 ] = { 3 , 4 , 5 , 7 } ; const size_t *
constraintDofs = NULL ; const size_t constraintDofOffsets [ 0 + 1 ] = { 0 } ;
const size_t Jm = 0 ; const size_t Jn = 4 ; SmSizePair zeroSizePair ;
...
Assembly_union_99d6582_1_resetSimStateVector ; delegate ->
...
Assembly_union_99d6582_1_perturbSimJointPrimitiveState ; delegate ->
mPerturbFlexibleBodyState = Assembly_union_99d6582_1_perturbFlexibleBodyState
...
Assembly_union_99d6582_1_constructStateVector ; delegate ->
mExtractSolverStateVector = Assembly_union_99d6582_1_extractSolverStateVector
; delegate -> mIsPositionViolation =
Assembly_union_99d6582_1_isPositionViolation ; delegate ->
mIsVelocityViolation = Assembly_union_99d6582_1_isVelocityViolation ;
delegate -> mProjectStateSim = Assembly_union_99d6582_1_projectStateSim ;
delegate -> mComputeConstraintError =
Assembly_union_99d6582_1_computeConstraintError ; delegate ->
mResetModeVector = Assembly_union_99d6582_1_resetModeVector ; delegate ->
mHasJointDisToNormModeChange =
Assembly_union_99d6582_1_hasJointDisToNormModeChange ; delegate ->
mPerformJointDisToNormModeChange =
Assembly_union_99d6582_1_performJointDisToNormModeChange ; delegate ->
mOnModeChangedCutJoints = Assembly_union_99d6582_1_onModeChangedCutJoints ;
delegate -> mMech = NULL ; } static void initMechanismDelegates (
NeDaePrivateData * smData ) { PmAllocator * alloc = pm_default_allocator ( )
; const int32_T motionInputOffsets [ 3 ] = { 0 , 1 , 2 } ; int_T status = 0 ;
...
( smData -> mMotionInputOffsets . mX , motionInputOffsets , 3 * sizeof (
...
} void Assembly_union_99d6582_1_NeDaePrivateData_create ( NeDaePrivateData *
