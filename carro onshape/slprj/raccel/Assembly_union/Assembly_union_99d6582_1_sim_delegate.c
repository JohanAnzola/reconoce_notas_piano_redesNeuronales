...
void Assembly_union_99d6582_1_resetSimStateVector ( const void * mech ,
...
Assembly_union_99d6582_1_constructStateVector ( const void * mech , const
double * solverState , const double * u , const double * uDot , double *
discreteState , double * fullState ) { ( void ) mech ; ( void ) discreteState
; fullState [ 0 ] = u [ 0 ] ; fullState [ 1 ] = u [ 1 ] ; fullState [ 2 ] =
solverState [ 0 ] ; fullState [ 3 ] = uDot [ 0 ] ; fullState [ 4 ] = uDot [ 1
] ; fullState [ 5 ] = solverState [ 1 ] ; fullState [ 6 ] = u [ 2 ] ;
fullState [ 7 ] = uDot [ 2 ] ; } void
...
] = fullState [ 2 ] ; solverState [ 1 ] = fullState [ 5 ] ; } int
...
void ) modeVector ; return 0 ; } int
Assembly_union_99d6582_1_isVelocityViolation ( const void * mech , const
RuntimeDerivedValuesBundle * rtdv , const int * eqnEnableFlags , const double
* state , const int * modeVector ) { const double * rtdvd = rtdv -> mDoubles
. mValues ; const int * rtdvi = rtdv -> mInts . mValues ; ( void ) mech ; (
void ) rtdvd ; ( void ) rtdvi ; ( void ) eqnEnableFlags ; ( void ) state ; (
void ) modeVector ; return 0 ; } PmfMessageId
Assembly_union_99d6582_1_projectStateSim ( const void * mech , const
...
void ) state ; ( void ) neDiagMgr ; return NULL ; } void
Assembly_union_99d6582_1_computeConstraintError ( const void * mech , const
...
) error ; } void Assembly_union_99d6582_1_resetModeVector ( const void * mech
, int * modeVector ) { ( void ) mech ; ( void ) modeVector ; } boolean_T
Assembly_union_99d6582_1_hasJointDisToNormModeChange ( const void * mech ,
const int * prevModeVector , const int * modeVector ) { ( void ) mech ; (
void ) prevModeVector ; ( void ) modeVector ; return 0 ; } PmfMessageId
Assembly_union_99d6582_1_performJointDisToNormModeChange ( const void * mech
, const RuntimeDerivedValuesBundle * rtdv , const int * prevModeVector ,
const int * modeVector , const double * input , double * state , void *
neDiagMgr0 ) { const double * rtdvd = rtdv -> mDoubles . mValues ; const int
* rtdvi = rtdv -> mInts . mValues ; NeuDiagnosticManager * neDiagMgr = (
NeuDiagnosticManager * ) neDiagMgr0 ; ( void ) mech ; ( void ) rtdvd ; ( void
