...
MODEL                = Assembly_union
MODULES              = DAHostLib_rtw.c HostLib_Audio.c Assembly_union_99d6582_1.c Assembly_union_99d6582_1_create.c Assembly_union_99d6582_1_setParameters.c Assembly_union_99d6582_1_asserts.c Assembly_union_99d6582_1_deriv.c Assembly_union_99d6582_1_checkDynamics.c Assembly_union_99d6582_1_asm_delegate.c Assembly_union_99d6582_1_sim_delegate.c Assembly_union_99d6582_1_mode_zero_crossings.c Assembly_union_99d6582_1_geometries.c Assembly_union_99d6582_1_gateway.c pm_printf.c rt_logging.c rt_backsubrr_dbl.c rt_forwardsubrr_dbl.c rt_lu_real.c rt_matrixlib_dbl.c Assembly_union.c Assembly_union_capi.c Assembly_union_data.c Assembly_union_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rt_logging_mmi.c rtw_modelmap_utils.c raccel_main_new.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c
PRODUCT              = Assembly_union.exe
MAKEFILE             = Assembly_union.mk
MATLAB_ROOT          = A:/Archivo de programas/Matlab R2020a
ALT_MATLAB_ROOT      = A:/Archivo de programas/Matlab R2020a
MATLAB_BIN           = A:/Archivo de programas/Matlab R2020a/bin
ALT_MATLAB_BIN       = A:/Archivo de programas/Matlab R2020a/bin
MASTER_ANCHOR_DIR    = 
START_DIR            = A:/Usuarios/TATTO PC/Desktop/univesidad/Procesamiento video y audio/proyecto 6 intelingencia artificial/carro onshape
S_FUNCTIONS_LIB      = $(MATLAB_ROOT)\sys\lcc64\lcc64\lib64\wsock32.lib
NUMST                = 4
NCSTATES             = 2
BUILDARGS            = MATLAB_ROOT=%MATLAB_ROOT% ALT_MATLAB_ROOT=%ALT_MATLAB_ROOT% MATLAB_BIN=%MATLAB_BIN% ALT_MATLAB_BIN=%ALT_MATLAB_BIN%  RSIM_SOLVER_SELECTION=2 PCMATLABROOT="A:\\Archivo de programas\\Matlab R2020a" EXTMODE_STATIC_ALLOC=0 EXTMODE_STATIC_ALLOC_SIZE=1000000 EXTMODE_TRANSPORT=0 TMW_EXTMODE_TESTING=0 RSIM_PARAMETER_LOADING=1 OPTS="-DTGTCONN -DNRT -DRSIM_PARAMETER_LOADING -DRSIM_WITH_SL_SOLVER -DENABLE_SLEXEC_SSBRIDGE=1 -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0 -DON_TARGET_WAIT_FOR_START=0 -DTID01EQ=0"
MULTITASKING         = 0
INTEGER_CODE         = 0
MAT_FILE             = 1
ALLOCATIONFCN        = 0
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(MATLAB_ROOT)/toolbox/shared/spc/src_ml/extern/include \
	-I$(MATLAB_ROOT)/toolbox/dsp/include \
	-I$(START_DIR)/slprj/raccel/Assembly_union \
...
DAHostLib_rtw.obj : $(MATLAB_ROOT)\toolbox\shared\spc\src_ml\extern\src/DAHostLib_rtw.c
	$(CC) -c -Fo$(@F) $(CFLAGS) $(MATLAB_ROOT)\toolbox\shared\spc\src_ml\extern\src/DAHostLib_rtw.c

HostLib_Audio.obj : $(MATLAB_ROOT)\toolbox\dsp\include/HostLib_Audio.c
	$(CC) -c -Fo$(@F) $(CFLAGS) $(MATLAB_ROOT)\toolbox\dsp\include/HostLib_Audio.c
...
rtiostream_utils.obj : A:\Archivo\ de\ programas\Matlab\ R2020a\toolbox\coder\rtiostream\src\utils/rtiostream_utils.c
	$(CC) -c -Fo$(@F) $(CFLAGS) A:\Archivo\ de\ programas\Matlab\ R2020a\toolbox\coder\rtiostream\src\utils/rtiostream_utils.c
